...
describe('component', () => {
  ...
  it('works', async () => {
    ...
    // 预期生成的文件
    const expectFiles = [
      `/src/app/${dasherizeName}/${dasherizeName}.component.ts`,
      `/src/app/${dasherizeName}/${dasherizeName}.component.html`,
      `/src/app/${dasherizeName}/${dasherizeName}.component.scss`,
      `/src/app/${dasherizeName}/${dasherizeName}.component.spec.ts`,
    ]
